 ...
 *
 */
public class CreUserAgentDomain implements Serializable{

	private static final long serialVersionUID = 1537989122050186434L;
	...
	private String isPay;//是否有支付宝支付信息
	
	private String isWhiteUser;//是否是羊毛党白名单
	
	private String isSetPwd;//是否设置压缩包密码

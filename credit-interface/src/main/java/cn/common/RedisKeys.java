...
public class RedisKeys {
	...
	/**
	 * 获取空号检测需要显示在前端进度页面上的号码
	 * 
	 * @param userId
	 * @return
	 */
	public String getMobileDisplayWebkey(String userId, String uid) {
		return userId+":web:" + uid;
	}
	
	/**
	 * 获取空号检测默认显示在前端进度页面上的号码
	 * 
	 * @param userId
	 * @return
	 */
	public String getDefaultMobileDisplayWebkey(String userId, String uid) {
		return userId+":web_default:" + uid;
	}
	 ...
	 * @return
	 */
	public String getWanShuFileUploadkey(String fileCode) {
		return "wanshu:fileUpload:" + fileCode;
	}
